...
<main>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about__image">
                        <img src="{{ empty($about->image) ? asset('frontend/img/images/about_img.png') : asset('images/about/' . $about->image ) }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <p class="short_description">{{ $about->short_description }}</p>
                                ...
                                <div class="about__award__wrap">
                                    <div class="row justify-content-center">
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{ asset('frontend/img/images/awards_01.png') }}" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{ asset('frontend/img/images/awards_02.png') }}" alt="">
                                                </div>
                                                <div class="award__content">
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{ asset('frontend/img/images/awards_03.png') }}" alt="">
                                                </div>
                                                <div class="award__content">
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{ asset('frontend/img/images/awards_04.png') }}" alt="">
                                                </div>
                                                <div class="award__content">
            ...
            <div class="services__style__two__wrap">
                <div class="row gx-0">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('frontend/img/icons/services_light_icon01.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('frontend/img/icons/services_light_icon02.png') }}" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('frontend/img/icons/services_light_icon03.png') }}" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('frontend/img/icons/services_light_icon05.png') }}" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('frontend/img/icons/services_light_icon06.png') }}" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('frontend/img/icons/services_light_icon04.png') }}" alt="">
                            </div>
                            <div class="services__style__two__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{ asset('frontend/img/icons/services_light_icon07.png') }}" alt="">
                            </div>
                            <div class="services__style__two__content">
                                <h3 class="title"><a href="services-details.html">Visual Design</a></h3>
                                <p>Strategy is a forward-looking plan for your brand’s behavior.Strategy is a forward-looking plan.</p>
    ...
    <section class="testimonial testimonial__style__two">
        ...
        <div class="testimonial__two__icons">
            <ul>
                <li><img src="{{ asset('frontend/img/icons/testi_shape01.png') }}" alt=""></li>
                <li><img src="{{ asset('frontend/img/icons/testi_shape02.png') }}" alt=""></li>
                <li><img src="{{ asset('frontend/img/icons/testi_shape03.png') }}" alt=""></li>
                <li><img src="{{ asset('frontend/img/icons/testi_shape04.png') }}" alt=""></li>
                <li><img src="{{ asset('frontend/img/icons/testi_shape05.png') }}" alt=""></li>
                <li><img src="{{ asset('frontend/img/icons/testi_shape06.png') }}" alt=""></li>
            </ul>
        </div>
    </section>
