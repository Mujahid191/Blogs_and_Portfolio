<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            {{-- asset('images/' . Auth::user()->image : Auth::user()->image ) --}}
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" 
                    src="{{ !(empty(Auth::user()->image))? asset('images/' . Auth::user()->image) : asset('images/no_image.jpg') }}"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('passwordUpdate') }}"><i class="ri-wallet-2-line align-middle me-1"></i> Change Password</a>
